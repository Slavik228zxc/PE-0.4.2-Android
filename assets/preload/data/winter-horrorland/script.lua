...
function onUpdate()
    ...
    if curBeat >= 31 then
        ...
        noteTweenX('defaultPlayerStrumX0', 4, defaultPlayerStrumX0 + 100 * math.sin((currentBeat+4 *0.25) * math.pi), 0.01)
        noteTweenX('defaultPlayerStrumX1', 5, defaultPlayerStrumX1 + 100 * math.sin((currentBeat+5 *0.25) * math.pi), 0.01)
        noteTweenX('defaultPlayerStrumX2', 6, defaultPlayerStrumX2 + 100 * math.sin((currentBeat+6 *0.25) * math.pi), 0.01)
        noteTweenX('defaultPlayerStrumX3', 7, defaultPlayerStrumX3 + 100 * math.sin((currentBeat+7 *0.25) * math.pi), 0.01)
        
        noteTweenX('defaultPlayerSRtrumX0', 0, 'defaultPlayerSStrumX0' + 100 * math.sin((currentBeat+4 *0.25) * math.pi), 0.01)
        noteTweenX('defaultPlayerSRtrumX1', 1, 'defaultPlayerSStrumX1' + 100 * math.sin((currentBeat+5 *0.25) * math.pi), 0.01)
        noteTweenX('defaultPlayerSRtrumX2', 2, 'defaultPlayerSStrumX2' + 100 * math.sin((currentBeat+6 *0.25) * math.pi), 0.01)
        noteTweenX('defaultPlayerSRtrumX3', 3, 'defaultPlayerSStrumX3' + 100 * math.sin((currentBeat+7 *0.25) * math.pi), 0.01)
